...
import {getSalaryPage, modifySalary} from "@/api/salary";
...
const queryParams = reactive<SalaryPageQuery>({
  pageNum: 1,
  pageSize: 10,
});
const userList = ref<Salary[]>();

const formData = reactive<Salary>({
  status: 1,
});
