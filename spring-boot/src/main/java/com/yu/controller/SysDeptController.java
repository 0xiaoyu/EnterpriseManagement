...
import com.yu.service.SysDeptService;
...
public class SysDeptController {
    ...
    @PostMapping
    @PreAuthorize("@security.hasPerm('sys:dept:add')")
    ...
    @PreAuthorize("@security.hasPerm('sys:dept:edit')")
    ...
    @DeleteMapping("/{ids}")
    @PreAuthorize("@security.hasPerm('sys:dept:delete')")
